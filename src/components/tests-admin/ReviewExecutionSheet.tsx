    ...
    <Modal visible transparent animationType="fade" onRequestClose={onCancel}>
      <View style={styles.overlay}>
        <TouchableOpacity
          ...
          onPress={onCancel}
        />
        <View style={styles.sheet} testID="review-execution-sheet">
          <Text style={styles.title}>
            {t("testsAdmin.executions.review.title")}
          </Text>

          <View style={styles.field}>
            <Text style={styles.label}>
              {t("testsAdmin.executions.review.noteLabel")}
            </Text>
            <Controller
              control={control}
              name="note"
          ...
          <View style={styles.actions}>
            <TouchableOpacity
              ...
              onPress={() => void onSave()}
              disabled={saving}
              testID="review-execution-submit-btn"
            >
              <Text style={styles.primaryButtonText}>
                {saving
                  ? t("testsAdmin.executions.review.submitting")
                  : t("testsAdmin.executions.review.submit")}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              onPress={onCancel}
              disabled={saving}
              testID="review-execution-cancel-btn"
            >
