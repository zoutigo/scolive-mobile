...
export const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    "health.admin.tabs.cares": "Événements hors école",
    ...
    "health.admin.profile.tabs.cares": "Historique",
  ...
  en: {
    ...
    "health.admin.tabs.cares": "Events outside school",
    ...
    "health.admin.stats.careEvents7d": "Care events (last 7 days)",
    "health.admin.stats.careEvents30d": "Care events (last 30 days)",
    ...
    "health.admin.profile.tabs.cares": "History",
    "health.admin.profile.tabs.conditions": "Conditions",
