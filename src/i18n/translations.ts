...
export const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    "onboardingTour.healthParent.tabsTitle": "Les 4 onglets de la santé",
    "onboardingTour.healthParent.tabsBody":
      "Retrouvez ici les informations importantes, les soins reçus à l'école, les événements que vous signalez et l'historique complet.",
    "onboardingTour.healthParent.conditionFormTitle": "Ajouter une information",
    "onboardingTour.healthParent.conditionFormBody":
      "Indiquez une allergie, une pathologie ou une instruction particulière. Le niveau détermine sa visibilité pour l'équipe pédagogique.",
    "onboardingTour.healthParent.reportFormTitle":
      "Signaler un événement hors école",
    "onboardingTour.healthParent.reportFormBody":
      "Maladie, accident, traitement... l'enseignant référent de la classe est automatiquement informé.",
    "onboardingTour.healthSchool.searchTitle": "Rechercher un élève",
    "onboardingTour.healthSchool.searchBody":
      "Tapez le nom d'un élève pour accéder à ses informations de santé.",
    "onboardingTour.healthSchool.urgencyBannerTitle": "Informations critiques",
    "onboardingTour.healthSchool.urgencyBannerBody":
      "Un bandeau rouge signale immédiatement les allergies ou pathologies urgentes, avec les contacts d'urgence des parents.",
    "onboardingTour.healthSchool.careEventFormTitle": "Enregistrer un soin",
    "onboardingTour.healthSchool.careEventFormBody":
      "Décrivez le soin apporté à l'élève : le parent reçoit automatiquement une notification.",
  },
  en: {
    ...
    "health.school.contacts": "Contacts",
    "onboardingTour.healthParent.tabsTitle": "The 4 health tabs",
    "onboardingTour.healthParent.tabsBody":
      "Find important information, care received at school, events you report and the full history.",
    "onboardingTour.healthParent.conditionFormTitle": "Add information",
    "onboardingTour.healthParent.conditionFormBody":
      "Record an allergy, a pathology, or a special instruction. The level sets its visibility to the teaching team.",
    "onboardingTour.healthParent.reportFormTitle":
      "Report an event outside school",
    "onboardingTour.healthParent.reportFormBody":
      "Illness, accident, treatment... the class referent teacher is automatically notified.",
    "onboardingTour.healthSchool.searchTitle": "Search a student",
    "onboardingTour.healthSchool.searchBody":
      "Type a student's name to access their health information.",
    "onboardingTour.healthSchool.urgencyBannerTitle": "Critical information",
    "onboardingTour.healthSchool.urgencyBannerBody":
      "A red banner immediately flags urgent allergies or pathologies, along with parents' emergency contacts.",
    "onboardingTour.healthSchool.careEventFormTitle": "Record a care event",
    "onboardingTour.healthSchool.careEventFormBody":
      "Describe the care given to the student: the parent is automatically notified.",
  },
};
